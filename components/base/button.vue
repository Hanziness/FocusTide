    ...
    <div class="relative">
      <div
        ...
        :class="[
          ...
          { 'group-hover:before:opacity-10 group-active:before:opacity-30': props.extendedBaseStyles },
          ...
          { 'bg-opacity-100 group-hover:shadow-sm group-hover:before:opacity-20 group-active:before:opacity-25 group-active:shadow-lg': props.importance === 1 },
          { 'border-2 bg-opacity-0 hover:bg-theme group-active:before:opacity-20 group-active:shadow-sm': props.importance === 2 },
          { 'bg-opacity-0 group-hover:bg-opacity-30 group-active:bg-opacity-60 group-focus:ring': props.importance === 3 }
        ]"
      />
